...
public class EnviroTreeBlock extends FlowerBlock {
	public EnviroTreeBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(EnvirocraftModBlocks.ENVIRO_TREE.get(), renderType -> renderType == RenderType.cutout());
	}
}
