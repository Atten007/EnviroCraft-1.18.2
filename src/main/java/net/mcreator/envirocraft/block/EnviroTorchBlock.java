...
public class EnviroTorchBlock extends Block {
	public EnviroTorchBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(EnvirocraftModBlocks.ENVIRO_TORCH.get(), renderType -> renderType == RenderType.cutoutMipped());
	}
