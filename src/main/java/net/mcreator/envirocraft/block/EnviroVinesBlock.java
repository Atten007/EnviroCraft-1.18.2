...
public class EnviroVinesBlock extends FlowerBlock {
	public EnviroVinesBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(EnvirocraftModBlocks.ENVIRO_VINES.get(), renderType -> renderType == RenderType.cutout());
	}
}
