...
public class EnviroPlantBlock extends FlowerBlock {
	public EnviroPlantBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(EnvirocraftModBlocks.ENVIRO_PLANT.get(), renderType -> renderType == RenderType.cutout());
	}
}
