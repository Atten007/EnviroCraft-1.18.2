...
public class EnviroFlowerLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroFlowerLeaveDecorator INSTANCE = new EnviroFlowerLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_flower_tree_leave_decorator");
