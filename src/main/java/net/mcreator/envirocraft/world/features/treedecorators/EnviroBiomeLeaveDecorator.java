...
public class EnviroBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroBiomeLeaveDecorator INSTANCE = new EnviroBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_biome_tree_leave_decorator");
