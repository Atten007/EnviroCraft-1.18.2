...
public class EnviroTaigaLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroTaigaLeaveDecorator INSTANCE = new EnviroTaigaLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_taiga_tree_leave_decorator");
