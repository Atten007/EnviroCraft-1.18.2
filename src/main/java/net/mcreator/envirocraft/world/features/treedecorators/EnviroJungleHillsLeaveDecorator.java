...
public class EnviroJungleHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroJungleHillsLeaveDecorator INSTANCE = new EnviroJungleHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_jungle_hills_tree_leave_decorator");
