...
public class EnviroWoodedLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroWoodedLeaveDecorator INSTANCE = new EnviroWoodedLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_wooded_tree_leave_decorator");
