...
public class EnviroSwampFruitDecorator extends CocoaDecorator {
	public static final EnviroSwampFruitDecorator INSTANCE = new EnviroSwampFruitDecorator();
	public static com.mojang.serialization.Codec<EnviroSwampFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_swamp_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public EnviroSwampFruitDecorator() {
		super(0.2f);
	}
