...
public class EnviroMountainsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroMountainsLeaveDecorator INSTANCE = new EnviroMountainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_mountains_tree_leave_decorator");
