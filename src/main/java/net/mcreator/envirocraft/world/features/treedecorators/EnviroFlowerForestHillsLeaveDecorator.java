...
public class EnviroFlowerForestHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroFlowerForestHillsLeaveDecorator INSTANCE = new EnviroFlowerForestHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_flower_forest_hills_tree_leave_decorator");
