...
public class EnviroSwampHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroSwampHillsLeaveDecorator INSTANCE = new EnviroSwampHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_swamp_hills_tree_leave_decorator");
