...
public class EnviroPineTaigaLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroPineTaigaLeaveDecorator INSTANCE = new EnviroPineTaigaLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_pine_taiga_tree_leave_decorator");
