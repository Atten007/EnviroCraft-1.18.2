...
public class EnviroBigTaigaHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroBigTaigaHillsLeaveDecorator INSTANCE = new EnviroBigTaigaHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_big_taiga_hills_tree_leave_decorator");
