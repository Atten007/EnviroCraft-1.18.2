...
public class EnviroLandsForestLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroLandsForestLeaveDecorator INSTANCE = new EnviroLandsForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_lands_forest_tree_leave_decorator");
