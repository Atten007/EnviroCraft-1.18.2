...
public class EnviroLandsHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroLandsHillsLeaveDecorator INSTANCE = new EnviroLandsHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_lands_hills_tree_leave_decorator");
