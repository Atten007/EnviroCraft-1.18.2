...
public class EnviroLandsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroLandsLeaveDecorator INSTANCE = new EnviroLandsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_lands_tree_leave_decorator");
