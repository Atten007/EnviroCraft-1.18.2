...
public class EnviroFlowerHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroFlowerHillsLeaveDecorator INSTANCE = new EnviroFlowerHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_flower_hills_tree_leave_decorator");
