...
public class EnviroLakeLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroLakeLeaveDecorator INSTANCE = new EnviroLakeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_lake_tree_leave_decorator");
