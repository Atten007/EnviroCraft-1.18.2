...
public class EnviroBigTaigaLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroBigTaigaLeaveDecorator INSTANCE = new EnviroBigTaigaLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_big_taiga_tree_leave_decorator");
