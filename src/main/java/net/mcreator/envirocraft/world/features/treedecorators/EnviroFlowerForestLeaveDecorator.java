...
public class EnviroFlowerForestLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroFlowerForestLeaveDecorator INSTANCE = new EnviroFlowerForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_flower_forest_tree_leave_decorator");
