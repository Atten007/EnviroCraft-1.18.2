...
public class EnviroIcyHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroIcyHillsLeaveDecorator INSTANCE = new EnviroIcyHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_icy_hills_tree_leave_decorator");
