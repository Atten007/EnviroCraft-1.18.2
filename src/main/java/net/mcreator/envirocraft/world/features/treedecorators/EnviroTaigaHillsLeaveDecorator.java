...
public class EnviroTaigaHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroTaigaHillsLeaveDecorator INSTANCE = new EnviroTaigaHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_taiga_hills_tree_leave_decorator");
