...
public class EnviroBirchForestHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroBirchForestHillsLeaveDecorator INSTANCE = new EnviroBirchForestHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_birch_forest_hills_tree_leave_decorator");
