...
public class EnviroWoodedHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroWoodedHillsLeaveDecorator INSTANCE = new EnviroWoodedHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_wooded_hills_tree_leave_decorator");
