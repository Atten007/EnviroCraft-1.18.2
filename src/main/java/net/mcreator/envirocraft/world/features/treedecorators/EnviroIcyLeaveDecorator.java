...
public class EnviroIcyLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroIcyLeaveDecorator INSTANCE = new EnviroIcyLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_icy_tree_leave_decorator");
