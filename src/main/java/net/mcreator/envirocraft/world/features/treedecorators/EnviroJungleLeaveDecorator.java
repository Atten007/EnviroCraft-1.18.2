...
public class EnviroJungleLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroJungleLeaveDecorator INSTANCE = new EnviroJungleLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_jungle_tree_leave_decorator");
