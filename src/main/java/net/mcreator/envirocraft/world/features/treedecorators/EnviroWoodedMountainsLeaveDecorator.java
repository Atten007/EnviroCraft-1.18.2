...
public class EnviroWoodedMountainsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroWoodedMountainsLeaveDecorator INSTANCE = new EnviroWoodedMountainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_wooded_mountains_tree_leave_decorator");
