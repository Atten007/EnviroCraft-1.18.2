...
public class EnviroLandsForestHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroLandsForestHillsLeaveDecorator INSTANCE = new EnviroLandsForestHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_lands_forest_hills_tree_leave_decorator");
