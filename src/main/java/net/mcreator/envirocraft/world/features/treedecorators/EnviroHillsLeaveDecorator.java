...
public class EnviroHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroHillsLeaveDecorator INSTANCE = new EnviroHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_hills_tree_leave_decorator");
