...
public class EnviroSavannaLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroSavannaLeaveDecorator INSTANCE = new EnviroSavannaLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_savanna_tree_leave_decorator");
