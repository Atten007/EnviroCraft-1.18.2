...
public class EnviroDesertLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroDesertLeaveDecorator INSTANCE = new EnviroDesertLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_desert_tree_leave_decorator");
