...
public class EnviroBirchForestLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroBirchForestLeaveDecorator INSTANCE = new EnviroBirchForestLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_birch_forest_tree_leave_decorator");
