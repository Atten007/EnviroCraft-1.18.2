...
public class EnviroTundraHillsLeaveDecorator extends LeaveVineDecorator {
	public static final EnviroTundraHillsLeaveDecorator INSTANCE = new EnviroTundraHillsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_tundra_hills_tree_leave_decorator");
