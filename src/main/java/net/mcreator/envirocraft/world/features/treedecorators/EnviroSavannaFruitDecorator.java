...
public class EnviroSavannaFruitDecorator extends CocoaDecorator {
	public static final EnviroSavannaFruitDecorator INSTANCE = new EnviroSavannaFruitDecorator();
	public static com.mojang.serialization.Codec<EnviroSavannaFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("enviro_savanna_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public EnviroSavannaFruitDecorator() {
		super(0.2f);
	}
