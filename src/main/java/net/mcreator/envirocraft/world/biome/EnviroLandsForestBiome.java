...
import net.mcreator.envirocraft.world.features.treedecorators.EnviroLandsForestTrunkDecorator;
import net.mcreator.envirocraft.world.features.treedecorators.EnviroLandsForestLeaveDecorator;
import net.mcreator.envirocraft.world.features.treedecorators.EnviroLandsForestFruitDecorator;
...
public class EnviroLandsForestBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:tree_enviro_lands_forest",
						FeatureUtils.register("envirocraft:tree_enviro_lands_forest", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(
										...
										new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))
												.decorators(ImmutableList.of(EnviroLandsForestLeaveDecorator.INSTANCE,
														EnviroLandsForestTrunkDecorator.INSTANCE, EnviroLandsForestFruitDecorator.INSTANCE))
												.build()),
						List.of(CountPlacement.of(1), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0),
								PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING))));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:grass_enviro_lands_forest", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:flower_enviro_lands_forest", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(4),
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(EnvirocraftModBiomes.ENVIRO_LANDS_FOREST.get())),
