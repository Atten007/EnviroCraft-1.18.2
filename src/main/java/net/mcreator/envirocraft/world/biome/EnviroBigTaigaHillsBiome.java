...
import net.mcreator.envirocraft.world.features.treedecorators.EnviroBigTaigaHillsTrunkDecorator;
import net.mcreator.envirocraft.world.features.treedecorators.EnviroBigTaigaHillsLeaveDecorator;
import net.mcreator.envirocraft.world.features.treedecorators.EnviroBigTaigaHillsFruitDecorator;
...
public class EnviroBigTaigaHillsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register(
				"envirocraft:tree_enviro_big_taiga_hills",
				FeatureUtils.register("envirocraft:tree_enviro_big_taiga_hills", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
						...
						new MegaPineFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0), UniformInt.of(13, 17)), new TwoLayersFeatureSize(1, 1, 2))
								...
								.decorators(ImmutableList.of(EnviroBigTaigaHillsLeaveDecorator.INSTANCE, EnviroBigTaigaHillsTrunkDecorator.INSTANCE,
										EnviroBigTaigaHillsFruitDecorator.INSTANCE))
								.build()),
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:grass_enviro_big_taiga_hills", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:flower_enviro_big_taiga_hills", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(7),
						RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:disk_sand_enviro_big_taiga_hills",
						FeatureUtils.register("envirocraft:disk_sand_enviro_big_taiga_hills", Feature.DISK,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:disk_gravel_enviro_big_taiga_hills",
						FeatureUtils.register("envirocraft:disk_gravel_enviro_big_taiga_hills", Feature.DISK,
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(EnvirocraftModBiomes.ENVIRO_BIG_TAIGA_HILLS.get())),
