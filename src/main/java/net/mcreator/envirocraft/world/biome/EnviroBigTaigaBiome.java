...
import net.mcreator.envirocraft.world.features.treedecorators.EnviroBigTaigaTrunkDecorator;
import net.mcreator.envirocraft.world.features.treedecorators.EnviroBigTaigaLeaveDecorator;
import net.mcreator.envirocraft.world.features.treedecorators.EnviroBigTaigaFruitDecorator;
...
public class EnviroBigTaigaBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register("envirocraft:tree_enviro_big_taiga",
				FeatureUtils.register("envirocraft:tree_enviro_big_taiga", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
						...
						new MegaPineFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0), UniformInt.of(13, 17)), new TwoLayersFeatureSize(1, 1, 2))
								...
								.decorators(ImmutableList.of(EnviroBigTaigaLeaveDecorator.INSTANCE, EnviroBigTaigaTrunkDecorator.INSTANCE,
										EnviroBigTaigaFruitDecorator.INSTANCE))
								.build()),
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:grass_enviro_big_taiga", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:flower_enviro_big_taiga", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(7),
						RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:disk_sand_enviro_big_taiga",
						FeatureUtils.register("envirocraft:disk_sand_enviro_big_taiga", Feature.DISK,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:disk_gravel_enviro_big_taiga",
						FeatureUtils.register("envirocraft:disk_gravel_enviro_big_taiga", Feature.DISK,
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(EnvirocraftModBiomes.ENVIRO_BIG_TAIGA.get())),
