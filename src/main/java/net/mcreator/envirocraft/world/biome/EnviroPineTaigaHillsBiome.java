...
import net.mcreator.envirocraft.world.features.treedecorators.EnviroPineTaigaHillsTrunkDecorator;
import net.mcreator.envirocraft.world.features.treedecorators.EnviroPineTaigaHillsLeaveDecorator;
import net.mcreator.envirocraft.world.features.treedecorators.EnviroPineTaigaHillsFruitDecorator;
...
public class EnviroPineTaigaHillsBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacementUtils.register(
				"envirocraft:tree_enviro_pine_taiga_hills",
				FeatureUtils.register("envirocraft:tree_enviro_pine_taiga_hills", Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
						...
						new MegaPineFoliagePlacer(ConstantInt.of(0), ConstantInt.of(0), UniformInt.of(3, 4)), new TwoLayersFeatureSize(1, 1, 2))
								.decorators(ImmutableList.of(EnviroPineTaigaHillsLeaveDecorator.INSTANCE, EnviroPineTaigaHillsTrunkDecorator.INSTANCE,
										EnviroPineTaigaHillsFruitDecorator.INSTANCE))
								.build()),
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:grass_enviro_pine_taiga_hills", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 2), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:flower_enviro_pine_taiga_hills", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(7),
						RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:disk_sand_enviro_pine_taiga_hills",
						FeatureUtils.register("envirocraft:disk_sand_enviro_pine_taiga_hills", Feature.DISK,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:disk_gravel_enviro_pine_taiga_hills",
						FeatureUtils.register("envirocraft:disk_gravel_enviro_pine_taiga_hills", Feature.DISK,
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(EnvirocraftModBiomes.ENVIRO_PINE_TAIGA_HILLS.get())),
