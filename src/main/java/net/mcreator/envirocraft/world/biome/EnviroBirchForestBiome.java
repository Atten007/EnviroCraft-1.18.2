...
import net.mcreator.envirocraft.world.features.treedecorators.EnviroBirchForestTrunkDecorator;
import net.mcreator.envirocraft.world.features.treedecorators.EnviroBirchForestLeaveDecorator;
import net.mcreator.envirocraft.world.features.treedecorators.EnviroBirchForestFruitDecorator;
...
public class EnviroBirchForestBiome {
	public static Biome createBiome() {
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:tree_enviro_birch_forest",
						FeatureUtils.register("envirocraft:tree_enviro_birch_forest", Feature.TREE,
								new TreeConfiguration.TreeConfigurationBuilder(
										...
										new BlobFoliagePlacer(ConstantInt.of(2), ConstantInt.of(0), 3), new TwoLayersFeatureSize(1, 0, 1))
												.decorators(ImmutableList.of(EnviroBirchForestLeaveDecorator.INSTANCE,
														EnviroBirchForestTrunkDecorator.INSTANCE, EnviroBirchForestFruitDecorator.INSTANCE))
												.build()),
						List.of(CountPlacement.of(10), InSquarePlacement.spread(), SurfaceWaterDepthFilter.forMaxDepth(0),
								PlacementUtils.HEIGHTMAP_OCEAN_FLOOR, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING))));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:grass_enviro_birch_forest", VegetationFeatures.PATCH_GRASS,
						List.of(NoiseThresholdCountPlacement.of(-0.8D, 5, 4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE,
								BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:flower_enviro_birch_forest", VegetationFeatures.FLOWER_DEFAULT, List.of(CountPlacement.of(8),
						RarityFilter.onAverageOnceEvery(32), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome())));
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:disk_sand_enviro_birch_forest",
						FeatureUtils.register("envirocraft:disk_sand_enviro_birch_forest", Feature.DISK,
		...
		biomeGenerationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION,
				PlacementUtils.register("envirocraft:disk_gravel_enviro_birch_forest",
						FeatureUtils.register("envirocraft:disk_gravel_enviro_birch_forest", Feature.DISK,
	...
	public static void init() {
		BiomeDictionary.addTypes(
				ResourceKey.create(Registry.BIOME_REGISTRY, BuiltinRegistries.BIOME.getKey(EnvirocraftModBiomes.ENVIRO_BIRCH_FOREST.get())),
